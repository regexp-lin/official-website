...
export default function Index() {
  const list = [
    {
      title: '免费',
      descript: '使用 言图 构建网站是完全免费的，前提是您了解 Web 开发流程。',
    },
    {
      title: 'SEO',
      descript:
    ...
    {
      title: '简单',
      descript: '您只需要使用 言图 的模版，然后按照我们的步骤即可拥有一个属于自己的网站。',
    },
    {
      title: '可扩展',
      descript: '言图 仅提供基础的功能，如果您有其他的需求可以自己进行开发，或者联系我。',
    },
  ]
  return (
    <main className="">
        ...
        <div className="relative h-full">
          ...
          <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
            <div className="text-center">
              <h1 className="text-4xl lg:text-6xl font-bold text-white mb-4">欢迎来到 言图</h1>
              <p className="text-lg lg:text-xl text-white">
                在这里，你可以使用它免费搭建属于你自己的网站，快来试试吧👉
                <a
                  href="https://github.com/AnsonZnl/言图"
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 from-gray-300 to-gray-700">
        <div className="py-2 text-center mb-4">
          <h2 className="text-center text-xl mb-2">言图 的优点</h2>
